...
<a href="javascript:void(0);" class="icon" onclick="myFunction()">
  ...
  <a href="bookCab.php">Book a ride</a>
...
<br></br>
    ...
    <h1>For cab drivers</h1>
    <p class="py-3">Enter the details below to register yourself. Our team will contact you in the next 24 hours
    </p>
